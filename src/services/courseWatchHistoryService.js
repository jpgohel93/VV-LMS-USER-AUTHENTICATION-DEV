...
const getLastAccessTopicViewHistory = async (userInputs) => {
    try{

        const { user_id, course_id } = userInputs;

        let CourseWatchHistoryData = await CourseWatchHistoryModel.getLastAccessTopicViewHistory(user_id, course_id);
