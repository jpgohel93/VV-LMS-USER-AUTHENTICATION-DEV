module.exports = {
    ...
    EMAIL_TEMPLATE_FACEBOOK_URL: process.env.BASE_URL + "local/email_assets/facebook.png",
    EMAIL_TEMPLATE_INSTAGRAM_URL: process.env.BASE_URL + "local/email_assets/instagram.png",
    EMAIL_TEMPLATE_LINKEDIN_URL: process.env.BASE_URL + "local/email_assets/linkedin.png",
    EMAIL_TEMPLATE_TWITTER_URL: process.env.BASE_URL + "local/email_assets/twitter.png",
    ...
    EMAIL_TEMPLATE_LOCK_URL: process.env.BASE_URL + "local/email_assets/lock.png",
    EMAIL_TEMPLATE_LOGO_URL: process.env.BASE_URL + "local/email_assets/logo.png",
    EMAIL_TEMPLATE_VV_LOGO_URL: process.env.BASE_URL + "local/email_assets/logo.png",
    EMAIL_TEMPLATE_VV_LOGO_BLACK_URL: process.env.BASE_URL + "local/email_assets/logo.png",
    EMAIL_TEMPLATE_PAID_URL: process.env.BASE_URL + "local/email_assets/paid_svg.png",
    EMAIL_TEMPLATE_UNPAID_URL: process.env.BASE_URL + "local/email_assets/unpaid_svg.png",
    ...
    INVOICE_STATUS_REFUNDED: process.env.BASE_URL + "local/invoice_assets/refunded.png",
    INVOICE_STATUS_UNPAID: process.env.BASE_URL + "local/invoice_assets/unpaid.png",
};